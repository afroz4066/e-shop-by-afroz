...
const ProductDetails = ({ data }) => {
  ...
  const handleMessageSubmit = () => {
    navigate("/inbox?conversation=507gdfsdhnj68dsnfhjdhs");
  };
  return (
    <div className="bg-white">
      {data ? (
        <div className={`${styles.section} w-[90%] 880px:w-[80%] h-[screen]`}>
        ...
        <div className="w-full block 800px:flex p-5">
          <div className="w-full 800px:w-[50%]">
            ...
            <div className="pt-2">
              ...
              culpa iste blanditiis, deserunt asperiores voluptates iusto sint
          ...
          <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
            <div className="text-left">
              <h5 className="font-[600]">
                Joined on: <span className="font-[500]">23 August,2023</span>
              </h5>
              <h5 className="font-[600] pt-3">
                Total Porducts: <span className="font-[500]">1,223</span>
              </h5>
              <h5 className="font-[600] pt-3">
                Total Review: <span className="font-[500]">332</span>
              </h5>
              <Link to="/">
                <div
